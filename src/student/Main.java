...
public class Main {
    public static void main(String[] args) {
        ...
        StudentManager studentManager = new StudentManager(100);  // Adjust capacity as needed
    ...
    private static void searchStudent(Scanner scanner, StudentManager studentManager) {
        ...
        switch (searchMethod) {
            case 1:
                ...
                break;
            case 2:
                studentManager.sortById();  // Ensure the list is sorted for binary search
    ...
    // Validate marks (must be between 0 and 10)
